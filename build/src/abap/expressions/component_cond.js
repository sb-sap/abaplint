...
class ComponentCond extends combi_1.Expression {
    getRunnable() {
        ...
        const another = combi_1.seq(combi_1.opt(combi_1.str("NOT")), combi_1.tok(tokens_1.WParenLeftW), new ComponentCond(), combi_1.tok(tokens_1.WParenRightW));
        const cnd = combi_1.alt(new _1.ComponentCompare(), another);

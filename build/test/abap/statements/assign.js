...
_utils_1.statementType(tests, "ASSIGN", Statements.Assign);
const versions = [
    { abap: "ASSIGN entity->* TO FIELD-SYMBOL(<entity>).", ver: version_1.Version.v740sp02 },
    { abap: "ASSIGN it_cols_width[ KEY primary_key col = lv_col ] TO FIELD-SYMBOL(<ls_cols_width>).", ver: version_1.Version.v740sp02 },
    { abap: "ASSIGN lt_table[ table_line->guid = lv_guid ] TO <target>.", ver: version_1.Version.v740sp02 },
];
_utils_1.statementVersion(versions, "ASSIGN", Statements.Assign);

...
_utils_1.statementType(tests, "METHODS", Statements.MethodDef);
const versions = [
    { abap: "METHODS method2 DEFAULT IGNORE.", ver: version_1.Version.v740sp08 },
];
_utils_1.statementVersion(versions, "METHODS", Statements.MethodDef);
